...
public class ESPipelineResultSet implements ResultSet {
	...
	public ESPipelineResultSet(Heading heading,ResultSet source){
		this(heading,source,1000);

	}
  public void add(Object value){
    row.add(value);
  }
	public ESPipelineResultSet(Heading heading,ResultSet source, int defaultRowLength){
	...
	public boolean isClosed() throws SQLException {
		return this.source.getStatement().isClosed();
	}
